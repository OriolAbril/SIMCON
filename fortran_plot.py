...
args=p.parse_args()
columndict={'T':0,'Cv':4,'E':1,'S':3,'F':3,'freq':0,'O1':1,'O2':2,'O3':3,'O4':4,'W1':5,'W2':6,'W3':7,'W4':8,'Total':9,'Exp':10,'IR':11,'Raman':12,'RamanD':13}
l1=len(args.files)
...
for doc in args.files:
    ...
    maxcol=docols[:]
    for ccc in docols:
        if ccc in columndict:
            docols[ll]=columndict[ccc]
            maxcol[ll]=columndict[ccc]
        else:
            docols[ll]=ccc
